...
\begin{res_experienceitem}{CTO}{SERPs.com}{Portland, OR}{September 2009}{March 2017}
  \item Created, developed, and maintained the full stack of a PaaS web analytics application as it grew to over 300 customers and \$50k MRR
  ...
  \item Maintained and improved queue-worker web crawling cluster using several stages to process and store data from \textgreater500k jobs per day
  \item Managed database servers and schema, updating and migrating data and structure as needs of the application changed and grew
