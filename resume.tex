...
\vspace*{2pt}
{\large
    \anon[]{503.662.2993}{555.867.5309} * Portland, OR * \anon[]{jobs@c9a.co}{fancy.email@gmail.com}\\
    \anon{cincodenada.com}{myportfolio.com} * github.com/\anon{cincodenada}{username}
}
\end{center}
...
\begin{rsubsection}{Proficiencies:}
  ...
  \rmfamily
  \begin{itemize}
    \item Experienced in C++17, Javascript/Typescript, Python, BigQuery, Redis, ZeroMQ, SQL, PHP, HTML5/CSS3
  ...
  \end{itemize}
  \item Frameworks used include React, Ember, Jest, Vue, Django, SQLAlchemy
