...
\begin{res_subsection}{Skills:}
  ...
  \item Efficiently troubleshooting systems and circuits, monitoring and administering Linux systems
...
\begin{res_subsection}{Proficiencies:}
  ...
  \end{itemize}
  \item Main tools and platforms used include Eagle, OpenSCAD, LAMP stack, Vim, Git, Vagrant, XDebug, GNU utilities
\end{res_subsection}
\end{res_section}
