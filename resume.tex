...
\begin{res_subsection}{Key Skills:}
  \item Developing distributed, reliable applications in a multi-cloud environment, from deployment to APIs
  \item Building high-throughput backend systems, balancing speed, complexity, and maintainability
...
\begin{res_section}{Experience}
  ...
  \item Designed and updated BigQuery databases to support new use cases and features in our platform
...
\begin{res_experienceitem}{Founding Engineer}{SERPs.com}{Portland, OR}{September 2009}{March 2017}
  ...
  \item Deployed and iterated on Node.js-based API service for programmatic access to our datastores
