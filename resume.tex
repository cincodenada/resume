...
\begin{res_experienceitem}{CTO}{\anon{SERPs.com}{SaaSCo}}{Portland, OR}{September 2009}{{\pt[Present]{March 2017}}}
  Buil\pt[d]{t} SaaS web analytics application from the ground up to over 400 customers and \$60k MRR:
  ...
  Wrangle\pt{d} a fleet of dozens of Linux servers to keep the app running smoothly:
  ...
  Manage\pt{d} MySQL servers and schema for 250GB dataset with \textgreater1m rows added per day:
  ...
  Support\pt{ed} and tested application
