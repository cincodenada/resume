...
\begin{res_section}{Proficiencies}
  \begin{res_content}{\textbf{Experienced in:}}%
    ...
    \raggedright
    \noindent%
    Modern C++, Javascript, Python, Puppet, BigQuery, SQL, PHP, HTML5/CSS3
    \end{sloppypar}
  \end{res_content}
  ...
  \begin{res_content}{\textbf{Dabbled in/interested in:}}%
    ...
    \raggedright
    \noindent%
    Ruby, Rust, Go, Scala, Haskell, Piet, MATLAB, Z80/M8C/MIPS Assembly
    \end{sloppypar}
  \end{res_content}
...
\begin{res_section}{Experience}
  \begin{res_experienceitem}{Senior Software Engineer 2}{Citrix (acquired Cedexis)}{Portland, OR}{2017}{2019}
...
\begin{res_experienceitem}{Founding Engineer}{SERPs.com}{Portland, OR}{Sep 2009}{{\pt[Present]{Mar 2017}}}
