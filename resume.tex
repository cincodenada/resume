...
\begin{res_subsection}{Proficiencies:}
  ...
  \end{itemize}
  \item Main tools and platforms used include Vim, Git, Vagrant, Docker, KiCad, OpenSCAD
  \item Passionate about charts, graphs, mapping, and other beautiful (geo)data
 \ifrobots
  \item Continued personal experience working with microcontrollers and EDA
 \fi
\end{res_subsection}
\end{res_section}
...
\end{res_experienceitem}
\ifrobots 
\begin{res_experienceitem}{Controller Pro}{Personal Project}{}{July 2013}{Ongoing}
  \item Wrote firmware to interface with classic controllers as modern USB HID devices
  \item Implemented communication with various proprietary protocols using AVR-based microcontroller
  \item Laid out several iterations of PCBs using Eagle and KiCad, optimizing for simplicity and ease of assembly
  \item Created novel algorithm to safely detect controller presence and identity
  \item Designed and printed custom hardware enclosure using OpenSCAD and FDM
\end{res_experienceitem}
\else
