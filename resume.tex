...
\newcommand{\gbullet}[2][circle]{
  \vcenter{\hbox{\includegraphics[height=7pt]{bullets/#1#2.png}}}
}
...
\begin{res_section}{Summary of Qualifications}
  ...
  Full-stack developer, experienced in desiging and implementing scripts, circuits, programs, and applications.
  ...
  \vskip 8pt Able to quickly understand and acclimate to large projects and systems, engaging productively within a team to help best use members' individual skills.
  Also adept at working with end-users personably and comfortably.

  \vskip 8pt Particularly passionate about charts, graphs, mapping, and other beautiful data.
