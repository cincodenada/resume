...
\begin{paracol}{2}
  ...
  \switchcolumn*[{%
    ...
    \hspace{\fill}
    \large Full-stack Senior Developer
    \end{color}
    \vspace*{1em}
  }]
  \switchcolumn
  ...
  {\large
    ...
    \begin{tabular}{c l}
      ...
      \faEnvelope & \anon[]{jobs@c9a.co}{fancy.email@gmail.com}\\
...
\begin{rsection}{Proficiencies}
  \begin{rpara}{Experienced in:}%
    \raggedright
    C++17, Javascript/Typescript, Python, Puppet, BigQuery, Redis, ZeroMQ, SQL, PHP, HTML5/CSS3
  \end{rpara}
  \begin{rpara}{Familiar with:}%
    \raggedright
    C, C\#, Java, R, Chef, Ansible, Perl, Bash scripting
  \end{rpara}
