...
{\large
    ...
    \anon[]{jobs@ell.codes}{fancy.email@gmail.com}\\
...
\begin{rsection}{Summary of Qualifications}
  ...
  \begin{rsubitems}{Proficiencies}
    ...
    \begin{itemize}
      ...
      \item Familiar with C, C\#, Rust, Ruby, Java, R, Chef, Ansible, Puppet, Perl, Bash scripting
...
\begin{rexperienceitem}{Senior Software Engineer}{TailorMed (acquired Vivor)}{Remote}{Jul 2020}{Oct 2023}
  ...
  \item Built and delivered FHIR data integration, iterating on design and requirements with partner organization
