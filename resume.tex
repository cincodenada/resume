...
\begin{rsubsection}{Proficiencies:}
  ...
  \rmfamily
  \begin{itemize}
    \item Experienced in C++17, Javascript, Python, Puppet, BigQuery, Redis, ZeroMQ, SQL, PHP, HTML5/CSS3
...
\begin{rexperienceitem}{}{TailorMed (acquired Vivor)}{Remote}{July 2020}{Present}
  ...
  \item Smoothly migrated XX tightly-integrated projects into a monorepo without disrupting team workflow, dramatically improving release times
  \item 
