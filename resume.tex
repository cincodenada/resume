...
\begin{res_experienceitem}{CTO}{SERPs.com}{Portland, OR}{September 2009}{current}
  ...
  \item Supervise and administer transition to a sharded, high-availability database cluster using MySQL Fabric and data warehousing
  \item Build out unit tests and continuous integration server for application codebase
  \item Add functionality and fix bugs in outdated C++ extension, allowing PHP to connect to current Fabric infrastructure
