...
\begin{res_experienceitem}{CTO}{\anon{SERPs.com}{SaaSCo}}{Portland, OR}{September 2009}{{\pt[Present]{March 2017}}}
  ...
  \item Supervise\pt{d} transition to a sharded HA database cluster using MySQL Fabric and data warehousing,
        ultimately improving pageload speed of primary customer-facing page 500x for large customers
  ...
  \item Buil\pt[d]{t} out monitoring system with TICK stack and Grafana, improving response time and speeding diagnosis of issues
